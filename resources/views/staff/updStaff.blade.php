...
<form method="POST" action="{{ route('updateStaff') }}">
    ...
    <div class="container-box">
        ...
        <input type="text" id="name" name="name" value="{{ Auth::user()->staff_Name }}" required><br><br>

        <label for="email">Email:</label>
        <input type="email" id="email" name="email" value="{{ Auth::user()->staff_Email }}" required><br><br>
        ...
        <input type="tel" id="phone" name="phone" value="{{ Auth::user()->staff_PhoneNum }}" pattern="^01[0-9]{8,9}$" required><br><br>
        ...
        <div class="btn-update2">
            <a href="{{ route('viewStaff') }}" class="btn2">CANCEL</a>
        </div>
