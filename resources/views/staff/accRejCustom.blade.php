            ...
            <table class="table table-hover">
                ...
                <tbody>
                    @foreach ($customizations as $customization)
                        <tr>
                            <td>{{ $customization->cust_ID }}</td> 
                            <td>{{ $customization->package_ID }}</td>
                            <td>{{ $customization->add_Hours }} hours</td> 
                            <td>{{ $customization->add_Ons }}</td>
                            <td>{{ $customization->add_Session }}</td>
                            <td>{{ $customization->add_Location }}</td>
